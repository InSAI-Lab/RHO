...
def main():
    ...
    parser.add_argument("--scene", required=True, 
                       choices=["berlin","sanfrancisco","detroit","washington","toulouse","montrouge","chicago","MountVernon", "detroit_clean"])
    ...
    parser.add_argument("--dest-dir", type=str, required=True, help="Destination directory for snowy images")
