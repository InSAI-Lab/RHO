...
from ..data import Mapillary360DataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_360.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = Mapillary360DataModule(cfg.get("data", {}))
