...
from ..data import MapillaryMixedDataModule
...
split_overrides = {
    "val": {
        "scenes":[
            ...
            "MGL_final/berlin",
            "MGL_final/chicago",
            "MGL_final/washington",
            "MGL_final/sanfrancisco",
            "MGL_final/toulouse",
            "MGL_final/montrouge",
            "MGL_rainy/detroit",
            "MGL_rainy/berlin",
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_mixed.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryMixedDataModule(cfg.get("data", {}))
