...
from ..data import MapillaryPanoFoggyDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_foggy.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoFoggyDataModule(cfg.get("data", {}))
