...
from ..data import MapillaryPanoMotionBlurDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_motion_blur.yaml")
data_cfg = OmegaConf.merge(
    data_cfg_train,
    {
        ...
        "add_map_mask": True,
        "max_init_error": 32,
        "loading": {"val": {"batch_size": 3, "num_workers": 3}},
    },
)
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoMotionBlurDataModule(cfg.get("data", {}))
