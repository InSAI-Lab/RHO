...
from ..data import MapillaryPanoNightDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_night.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoNightDataModule(cfg.get("data", {}))
