...
from ..data import MapillaryPanoOverExposureDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_over_exposure.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoOverExposureDataModule(cfg.get("data", {}))
