...
from ..data import MapillaryPanoRainyDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_rainy.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoRainyDataModule(cfg.get("data", {}))
