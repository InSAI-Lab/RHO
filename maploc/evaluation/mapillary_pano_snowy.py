...
from ..data import MapillaryPanoSnowyDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_snowy.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoSnowyDataModule(cfg.get("data", {}))
