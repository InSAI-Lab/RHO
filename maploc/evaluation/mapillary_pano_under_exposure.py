...
from ..data import MapillaryPanoUnderExposureDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_pano_under_exposure.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoUnderExposureDataModule(cfg.get("data", {}))
