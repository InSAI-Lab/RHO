...
from ..data import Sim2RealDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "sim2real.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = Sim2RealDataModule(cfg.get("data", {}))
