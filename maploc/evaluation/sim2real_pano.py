...
from ..data import Sim2RealPanoDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "sim2real_pano.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = Sim2RealPanoDataModule(cfg.get("data", {}))
